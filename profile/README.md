...
3. [Notification](https://github.com/projectsveltos/sveltos/blob/main/docs/notifications.md): Sveltos can be configured to send notifications (Kubernetes event and Slack, Webex messages) when for instance all add-ons are deployed in a cluster;
